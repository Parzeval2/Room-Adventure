...
class Game(Frame):
    ...
    def setup_game(self):
        ...
        r5.add_item("Cosmic Egg", "You look at the egg and are filled with great joy. You feel complete. It is done.")
        # add grabs
        r1.add_grabs("key")
        r2.add_grabs("fire")
        r3.add_grabs("doug")
    ...
    def handle_go(self, destination):
        ...
        global voiceline
        if (destination in self.current_room.exits) or (destination == "egg" and destination in self.inventory):
